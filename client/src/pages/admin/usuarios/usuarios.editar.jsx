...
export default function UsuarioCadastrar() {
   ...
   async function handleSubmit(){
      const data = {nome_usuario: nome, sobrenome_usuario: sobrenome, cpf_usuario: cpf,  telefone_usuario: telefone, email_usuario: email,  senha_usuario: senha, _id: idUsuario}
